	...
	trk2=videoTags.length;
		...
		for (let k = trk; k<videoTags.length; k++) {
				...
				trk--;
						...
						sdivs[i].innerHTML='<div style="display: initial !important; visibility: initial !important; z-index: '+Number.MAX_SAFE_INTEGER+' !important; position: inherit; pointer-events: auto; border-color: cyan; border-width: 0.1ch; border-style: solid; border-radius: 50%; user-select: none;">TL</div><div style="display: initial !important; visibility: initial !important; z-index: '+Number.MAX_SAFE_INTEGER+' !important; position: inherit; pointer-events: auto;  border-color: cyan; border-width: 0.1ch; border-style: solid; border-radius: 50%; user-select: none;">TR</div><div style="display: initial !important; visibility: initial !important; z-index: '+Number.MAX_SAFE_INTEGER+' !important; pointer-events: auto;  border-color: cyan; border-width: 0.1ch; border-style: solid; border-radius: 50%; position: inherit; user-select: none;">BL</div><div style="display: initial !important; visibility: initial !important; z-index: '+Number.MAX_SAFE_INTEGER+' !important; pointer-events: auto; border-color: cyan; border-width: 0.1ch; border-style: solid; border-radius: 50%; position: inherit; user-select: none;">BR</div>';
						...
						window.addEventListener('pointermove', e => {
							...
							if(passth===false){
								let wcs=window.getComputedStyle(t);
								if(wcs['cursor']!=='none'){
									passth=true;
								}
							}
